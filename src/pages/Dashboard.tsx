  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow p-5 border-l-4 border-cyan-500 flex justify-between items-center">
          <div>
        ...
        <div className="bg-white rounded-lg shadow p-5 border-l-4 border-indigo-500 flex justify-between items-center">
          <div>
        ...
        <div className="bg-white rounded-lg shadow p-5 border-l-4 border-amber-500 flex justify-between items-center">
          <div>
        ...
        <div className="bg-white rounded-lg shadow p-5 border-l-4 border-red-500 flex justify-between items-center">
          <div>
